...
{if and($order_item.type|ne( 'directebankingpaycode' ), $order_item.type|ne( 'paymentgatewayhandler' ))}
<tr class="{$style}">
    <td>
...
1. {'Open sofortueberweisung.de/paycode'|i18n('extension/directebankingpaycode/common')}<br />
2. {'Enter your code in the text field'|i18n('extension/directebankingpaycode/common')}<br />
3. {'Click on &quot;Start payment&quot; to start the payment procedure'|i18n('extension/directebankingpaycode/common')}<br /><br />
{/if}
{/if}
{/foreach}
