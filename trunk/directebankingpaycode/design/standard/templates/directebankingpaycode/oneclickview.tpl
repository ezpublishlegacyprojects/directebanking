            ...
            <div class="box-content">
                <div class="context-attributes">
                    ...
                    <form method="get" action="https://www.sofortueberweisung.de/payment/createNew">
                        ...
                        <input type="hidden" name="projectspaymentsetting_interface_success_link" value="{concat( 'http://', ezini('SiteSettings','SiteURL'),'directebankingpaycode/success')}"/>
                        <input type="hidden" name="projectspaymentsetting_interface_cancel_link" value="{concat( 'http://', ezini('SiteSettings','SiteURL'),'directebankingpaycode/failed')}"/>
                        ...
                        <input type="hidden" name="projectsnotification_http_url" value="{concat( 'http://', ezini('SiteSettings','SiteURL'),'directebankingpaycode/notificate')}"/>
                        <input type="hidden" name="projectsnotification_http_method" value="1"/>
                        
                        <input type="hidden" name="backlink" value="{'/directebankingpaycode/oneclickinstallation/register'|ezurl('no','full')}" />
                        <input type="hidden" value="0" name="debug" />
                        <input type="submit" value="{'create new'|i18n('extension/directebankingpaycode/modules')}" />
                    </form>
                </div>
            </div>
        </div>
