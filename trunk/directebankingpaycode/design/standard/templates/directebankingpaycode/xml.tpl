            ...
            <div class="box-ml">
                <div class="box-mr">
                    <div class="box-tl">
                        <div class="box-tr">
                            <div>
                                <h2 class="context-title">{'XML-Interface'|i18n('extension/directebankingpaycode/common')}</h2>
                            </div>
            ...
            <div class="box-content">
                <div class="context-attributes">
                    ...
                    {else}
                        ...
                        <form method="post" action="{'/directebankingpaycode/xml'|ezurl(no)}">
                            <label>UserID: <b>{ezini( 'PaycodeSettings', 'UserID', 'directebankingpaycode.ini' )}</b></label><br />
                            <label>ProjectID: <b>{ezini( 'PaycodeSettings', 'ProjectID', 'directebankingpaycode.ini' )}</b></label><br />
                            ...
                            {/literal}
                            <p><input type="submit" name="GetXML" value="{'Submit'|i18n('extension/directebankingpaycode/common')}" /></p>
                        </form>
                    {/if}
                </div>
            </div>
