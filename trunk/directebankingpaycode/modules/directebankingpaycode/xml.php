...
if( $http->hasVariable( 'GetXML' ) )
{
    ...
    $serverurl .= "user_id=" . $ini->variable( "PaycodeSettings", "UserID" );
    $serverurl .= "&project_id=" . $ini->variable( "PaycodeSettings", "ProjectID" );
...
$Result['content'] = $tpl->fetch( 'design:directebankingpaycode/xml.tpl' );
$Result['path'] = array( array( 'url' => '/directebankingpaycode/xml',
